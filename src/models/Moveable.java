...
public class Moveable extends Pane {
    ...
    public boolean collision(Moveable other) {
        if (Math.abs(getTheCenterHitBoxX() - other.getTheCenterHitBoxX()) > getTheHalfSizeHitBoxX() + other.getTheHalfSizeHitBoxX())
            return false;
        if (Math.abs(getTheCenterHitBoxY() - other.getTheCenterHitBoxY()) > getTheHalfSizeHitBoxY() + other.getTheHalfSizeHitBoxY())
            return false;
        return true;
    }

    public boolean attackTouch(Moveable other) {
        if (Math.abs(getTheCenterAttackX() - other.getTheCenterHitBoxX()) > getTheHalfSizeAttackX() + other.getTheHalfSizeHitBoxX())
            return false;
        if (Math.abs(getTheCenterAttackY() - other.getTheCenterHitBoxY()) > getTheHalfSizeAttackY() + other.getTheHalfSizeHitBoxY())
            return false;
        return true;
    }
